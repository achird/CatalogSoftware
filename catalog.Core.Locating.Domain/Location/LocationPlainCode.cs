...
/// </summary>
public class LocationPlainCode : ValueObject<LocationPlainCode>
{
    private LocationPlainCode(string value)
    {
        Value = value;
    }
    ...
    /// <returns></returns>
    public static LocationPlainCode Create(string value)
    {
    ...
    private static readonly string pattern = @"^\d{11}$|^\d{15}$";

    /// <summary>
    /// Пустое значение
    /// </summary>
    public static readonly LocationPlainCode Empty = new(string.Empty);
